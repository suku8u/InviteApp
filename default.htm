...
<!--[if lt IE 7]><p class="chromeframe">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">activate Google Chrome Frame</a> to improve your experience.</p><![endif]-->
	...
	<section id="top">
    	<div class="landing-container">
        	<div class="landing-row">
                ...
                <img src="images/photos/landing-photo.jpg" class="editable" id="landing-photo" />
            </div><!-- .landing-row -->
    ...
    <section>
    	<div id="menu1">
        	<div class="anchorContainer menu1 editable" id="content-one">
                <div class="row">
                	<div class="twelvecol">
                    	<blockquote>
        ...
        <div id="menu2">
        	<div class="anchorContainer menu2 editable" id="content-two">
                <div class="row">
                    <div class="twelvecol">
                        <ul class="gallery clearfix">
                            ...
                            <li class="repeatable"><a href="images/photos/image1.jpg" rel="photo[gallery1]" title="Click expand button on top right corner to view larger image."><img src="images/thumbs/image1.jpg" width="136" height="136" alt="Add photo title here" /></a></li>
                            ...
                            <li class="repeatable"><a href="images/photos/image3.jpg" rel="photo[gallery1]"><img src="images/thumbs/image3.jpg" width="136" height="136" alt="Add photo title here" /></a></li>
        ...
        <div id="menu6">
            ...
            </div><!-- .anchorContainer .menu6 -->
        </div><!-- #menu6 -->
    </section>
    <div class="clear"></div>
    
    <footer class="editable" id="footer">
    	<div class="container">
        	<div class="row">
                <div class="twelvecol">
